...
/* /Users/alex/Documents/GitHub/darling/themes/demo/partials/site/header.htm */
class __TwigTemplate_98324f144b464c5482110fdedd254d0325473d81deeb6bd995942922e2113c85 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<!--            <img src=\"";
        ...
        <div class=\"MainMenu\" onclick=\"openMenuHandler()\">
            <div class=\"MainMenu-Icon\" data-openMenu=\"menu-icon\"></div>
        </div>
    </div>
...
div.remove();
    ...
    function openMenuHandler() {
        ...
        let scrollbarWidth = Number(
                                ...
                                document.querySelectorAll('.MainMenu-Icon')[0]).width.replace('px', '')) + scrollWidth - 7
        
        
        if(logoHolder.classList.contains('js-OpenedMenu')) {
            menuButton.style.width = scrollbarWidth + 'px'
            menuButtonFixed.style.width = scrollbarWidth + 'px'
        } else {
            menuButton.style.width = ''
            menuButtonFixed.style.width = ''
        }
    ...
    window.addEventListener('load', function(){
        ...
        if (localStorage.getItem('menuIsOpened') == 'true') {
            console.log('true')
            openMenuHandler()
    ...
    {
        return "/Users/alex/Documents/GitHub/darling/themes/demo/partials/site/header.htm";
    }
...
</script>", "/Users/alex/Documents/GitHub/darling/themes/demo/partials/site/header.htm", "");
    }
}
